...
document.write('<table id="fc" style="position:absolute; z-index: 100; border-collapse:collapse;background:#FFFFFF;border:1px solid #FFD088;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
function today() {
    updobj.value=addnull(now.getDate(),now.getMonth()+1,now.getYear());
    getObj('fc').style.display='none';
